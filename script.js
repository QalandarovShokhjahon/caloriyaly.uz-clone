...
// ===============================
const TELEGRAM_BOT_TOKEN = '8123001382:AAE_ODHez3xdoMyE0Oi8Axs7ItZASD8hhFQ';     // Bot tokeningiz
const TELEGRAM_CHAT_ID = '5522089798';     // Chat ID yoki kanal ID

// Buyurtmani Telegramga yuborish funksiyasi
async function sendOrderToTelegram() {
  ...
  const deliveryAddress = prompt("Manzilingizni kiriting:");
...
// Checkout tugmasini bosishni kuzatish
const checkoutBtn = document.getElementById("checkoutBtn");
if (checkoutBtn) {
